            ...
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-semibold transition-all duration-200 border
                ${selectedCategory === cat
                  ? 'bg-[#1e5f9e] text-white border-[#1e5f9e]'
                  : 'bg-white text-gray-600 border-gray-200 hover:border-[#28a8e0] hover:text-[#28a8e0]'
                }`}
            >
              {cat}
            </button>
            ...
            return (
              ...
              >
                ...
                <div className="p-5 flex flex-col flex-1">
                  ...
                  <h2 className="font-bold text-[#0a2d5e] text-lg leading-snug mb-2 group-hover:text-[#1e5f9e] transition-colors">
                    {post.title}
                  </h2>
  ...
  return (
    <div className="min-h-screen bg-[#f8fbff]">
      ...
      <div className="relative h-64 md:h-80">
        <img src={`${post.image}&w=1200`} alt={post.title} className="w-full h-full object-cover" />
      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="mt-10 bg-[#0a2d5e] rounded-2xl p-8 text-center text-white">
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            <Link
              to="/kontakt"
              className="inline-flex items-center gap-2 bg-[#28a8e0] hover:bg-[#1e8fc0] text-white px-5 py-2.5 rounded-lg font-semibold text-sm transition-all"
            >
              Kontaktirajte nas <ArrowRight size={14} />
            </Link>
            <Link
              to="/blog"
              className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white border border-white/20 px-5 py-2.5 rounded-lg font-semibold text-sm transition-all"
            >
              ← Svi članci
            </Link>
          </div>
